...
// No Limit Switch Collector
  public Command collectCommand() {
    return run(() -> {
      ...
      m_frontcollectorVictorSPX.set(-0.5);
    }).andThen(
      runOnce(() -> {
      m_leftcollectorVictorSPX.stopMotor();
      m_rightcollectorVictorSPX.stopMotor();
  ...
  public Command collectReverseCommand() {
    return run(() -> {
      m_leftcollectorVictorSPX.set(-0.75);
      m_rightcollectorVictorSPX.set(0.75);
      m_frontcollectorVictorSPX.set(0.75);
    }).andThen(
      runOnce(() -> {
        m_leftcollectorVictorSPX.stopMotor();
        m_rightcollectorVictorSPX.stopMotor();
  ...
  public Command launchCommand() {
    return run(() -> {
      m_launchLeftVictorSPX.set(0.75);
      m_launchRightVictorSPX.set(-0.70);
      m_leftcollectorVictorSPX.set(0);
      m_rightcollectorVictorSPX.set(0);
