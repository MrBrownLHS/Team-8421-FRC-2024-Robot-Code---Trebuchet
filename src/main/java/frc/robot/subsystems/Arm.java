...
public class Arm extends SubsystemBase {
  private PWMSparkMax m_ArmLeftSparkMax = null;
  private PWMSparkMax m_ArmRightSparkMax = null;
  ...
  /** Creates a new Arm. */
  public Arm() {
    m_ArmLeftSparkMax = new PWMSparkMax(Constants.PivotConstants.PIVOT_MOTOR_LEFT_SPARKMAX);
    m_ArmRightSparkMax = new PWMSparkMax(Constants.PivotConstants.PIVOT_MOTOR_RIGHT_SPARKMAX);
  ...
  public Command pivotforwardCommand() {
    return run(() -> {
      m_ArmLeftSparkMax.set(0.25);
      m_ArmRightSparkMax.set(-0.25);
